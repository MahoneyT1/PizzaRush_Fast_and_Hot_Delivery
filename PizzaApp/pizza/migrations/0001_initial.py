    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_type', models.CharField(choices=[('Starters', 'Starters'), ('Classic', 'Classic'), ('Vegetarian', 'Vegetarian'), ('Meat-Lover’s', 'Meat-Lover’s')], default='Starters', max_length=30, null=True)),
